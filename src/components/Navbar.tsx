...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navItems = [
    { id: 'home', label: 'Home', icon: HomeIcon, count: undefined },
    { id: 'generator', label: 'Generator', icon: Utensils, count: undefined },
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  key={item.id}
                  id={`nav-link-${item.id}`}
                  onClick={() => handleNavClick(item.id as ActiveTabType)}
